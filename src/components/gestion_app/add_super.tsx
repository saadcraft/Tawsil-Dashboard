...
import { AddSuperViseur, Data } from '@/lib/super_action'
        ...
        <div className='py-5 px-5 sm:px-16'>
            ...
            <div className='py-10 max-w-2xl mx-auto bg-white rounded-md shadow-md'>
                <form onSubmit={handleSubmit} className='flex flex-col gap-4 py-5 px-2 sm:px-5 lg:px-10'>
                    <h1 className="text-xl font-bold">Créer Superviseur</h1>
                    ...
                    <div className='flex flex-col gap-1 p-1'>
                        ...
                        <select className='border p-1' name='sexe' id="sexe" value={formData.sexe} onChange={handleChange}>
