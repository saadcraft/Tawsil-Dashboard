...
export default function Profile({ user }: { user: Users }) {
    return (
        <div className='py-5 px-5 sm:px-16'>
            ...
            <div className='relative top-20 md:top-10 p-10 pb-20 max-w-5xl mx-auto bg-white rounded-md shadow-md'>
                ...
                <div className="flex justify-center items-center h-5/6 gap-10 rounded-lg text-xs md:text-lg">
                    <div className="font-semibold space-y-4 text-gray-700">
                        <p>email :</p>
                        <p>Télephone :</p>
                        <p>Role:</p>
                    ...
                    <div className="border-l pl-4 space-y-4 text-gray-600">
                        <p>{user.email}</p>
