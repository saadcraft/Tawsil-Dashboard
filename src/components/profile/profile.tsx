        ...
        <div className='py-5 px-5 sm:px-16'>
            ...
            <div className='relative top-20 md:top-10 pt-10 md:px-10 px-2 pb-10 max-w-5xl mx-auto bg-white rounded-md shadow-md'>
                ...
                <div className='flex justify-center items-center'>
                    <p className='font-semibold ml-5 text-3xl p-3 text-center'>{user.last_name + " " + user.first_name} saadsaad</p>
                    <MdOutlineEdit onClick={() => setmodify("nom")} className=' text-2xl text-gray-600 cursor-pointer hover:text-gray-950' />
                </div>
